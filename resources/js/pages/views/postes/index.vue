                ...
                <div class="card-body">
                  <div class="overflow-auto custom-scroll"> 
                    <table class="table equal-space table-action invoice">
                      ...
                      <tbody> 
                        <tr class="hover:bg-gray-light dark:hover:bg-sidebar-dark2 invoice-item" v-for="job in jobs" :key="job.id">
                         
                          <td class="min-w-[7.5rem]"> 
                            <h4 class="text-xs font-semibold text-title">{{ job.name }}</h4>
                          </td>
                          <td class="min-w-[7.5rem]"> 
                            <h4 class="text-xs font-semibold text-content">{{ job.description}}</h4>
                          </td>
                          
                          <td class="min-w-[3.125rem] text-right">
                            <div class="items-center gap-3 flex 2lg:hidden"> 
                              <router-link :to="{name: 'EditJob',params:{jobId:job.id}}">
